    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
            ...
            <div className="flex gap-2 flex-wrap mb-3">
              {product.categorias.map((cat) => (
                <Link
                  ...
                  className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full hover:bg-accent transition-colors"
                >
                  {cat.nombre}
                </Link>
              ))}
          ...
          {product.descripcion && (
            <p className="text-muted-foreground mb-6 leading-relaxed">{product.descripcion}</p>
          )}
          ...
          <div className="flex gap-4 mb-6">
            ...
            <div className={`flex items-center gap-1 text-sm ${outOfStock ? 'text-destructive' : 'text-primary'}`}>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Quantity selector */}
          <div className="mb-4">
            <h3 className="text-sm font-semibold text-foreground mb-2">Cantidad</h3>
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-colors ${
                        isExcluded ? 'bg-destructive/10 line-through text-destructive' : 'hover:bg-accent'
                      }`}
                    >
                      <input
                        type="checkbox"
